...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0ca364b6d94c2ca397bf61ed46a970d5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Build system (like make) that used md5 to determine builds\nrather than timestamps";
          description = None;
          categories = [];
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Lexer"; "Parser"];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "core"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "remodel.ml"; })
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "l\159\127\215{b\0243\190\188c\138\249\020\161\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
