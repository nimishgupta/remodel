...
(* OASIS_START *)
(* DO NOT EDIT (digest: ccaafddf82847ca2e4aa6d01443483c6) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Build"; "DAG"; "DB"; "DirtySet"; "Rules"; "Vertex"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\156v\024\168\244\182Nb\255C!\241\215\170\017\196";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
