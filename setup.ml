...
(* OASIS_START *)
(* DO NOT EDIT (digest: e014d638f97de8697432271f4c599b8f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["DB"; "Dependencies"; "DirtySet"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\203\149\159\004\171\232B\151F\142h\246\215>\022[";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
